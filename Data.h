...
void Data::initialiseMapCoordinates() {
  m["S1"] = {{3, 5}, {3, 6}, {4, 5}, {4, 6}};
  m["S2"] = {{2,2},{3,2},{4,2},{5,2}};
  g["S1"] = 1, g["S2"] = 1;
  ...
  m["B3"] = {{9, 6}};
  m["B4"] = {{7, 6}};
  m["B5"] = {{6,1},{7,1},{8,1},{9,1},{10,1}};
  g["B1"] = 2, g["B2"] = 2, g["B3"] = 2, g["B4"] = 2, g["B5"] = 2;
  ...
  m["P7"] = {{13, 3}, {13, 4}, {13, 5}};
  m["P8"] = {{11, 3}, {11, 4}, {11, 5}};
  m["P9"] = {{11,1},{12,1},{13,1},{14,1},{15,1},{16,1},{17,1},{18,1},{19,1},{20,1},{21,1}};
  g["P7"] = 4, g["P8"] = 4, g["P9"] = 4;

  m["F"] = {{23, 3}, {23, 4}};
  m["FF2"] = {{22,1},{23,1},{24,1},{25,1},{26,1}};
  m["FF3"] = {{26,2},{26,2},{26,3},{26,4}};
  g["F"] = 5, g["FF2"] = 5, g["FF3"] = 5;
  ...
  m["R2"] = {{5, 24}, {5, 25}, {5, 26}};
  m["R3"] = {{7, 24}, {7, 25}, {7, 26}};
  m["R4"] = {{3,29},{4,29},{5,29},{6,29},{7,29},{8,29}};
  g["R1"] = 8, g["R2"] = 8, g["R3"] = 8, g["R4"] = 8;
  ...
  m["C5"] = {{12, 26}};
  m["C6"] = {{14, 26}};
  m["C7"] = {{9,29},{10,29},{11,29},{12,29},{13,29},{14,29},{15,29}};
  g["C1"] = 9, g["C2"] = 9, g["C3"] = 9, g["C4"] = 9, g["C5"] = 9, g["C6"] = 9, g["C7"] = 9;

  m["A1"] = {{21, 24}, {21, 25}, {21, 26}};
  m["A2"] = {{19, 24}, {19, 25}, {19, 26}};
  m["A3"] = {{17, 24}, {17, 25}, {17, 26}};
  m["A4"] = {{16,29},{17,29},{18,29},{19,29},{20,29},{21,29},{22,29}};
  g["A1"] = 10, g["A2"] = 10, g["A3"] = 10, g["A4"] = 10;
  ...
  // billing counter
  m["BC"] = {{23, 10}, {23, 12}, {23, 14}, {23, 16}, {23, 18}, {23, 20}};
  g["BC"] = 18;

  //storage cells
  m["S"] = {{27,5},{27,9},{27,10},{27,11},{27,12},{27,13},{27,14},{27,15},{27,16},
          {27,17},{27,18},{27,19},{27,20},{27,21},{27,22},{27,23},{27,24},{27,28},{27,29}};
  g["S"] = 19;
...
void Data::initialiseProducts() {
  prod = {{1, "M1", 3, 9},   {2, "P6", 19, 3},  {3, "P3", 15, 5},
